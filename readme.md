...
| [Robbing Houses](problems/robbing-houses) (DP)                                               | 2     | O(n)/O(1)                             | Maximise your profit from robbing houses under certain conditions                                             |
...
| [Palindromic Substrings](problems/palindromic-substrings)                                    | 3     | O(n<sup>2</sup>)/O(1)                 | Count how many palindromic substrings are in the string                                                       |
...
| [Target Sum](problems/target-sum) (DP)                                                       | 4     | O(n<sup>2</sup>)/O(n)                 | Find the number of ways to get the given sum from array of numbers by assigning signs to them                 |            
