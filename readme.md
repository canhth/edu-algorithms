...
| [Word Break](problems/word-break) (DP)                                                       | 3     | O(n<sup>2</sup>)/O(max(n, ds))        | Having a dictionary of words, determine whether the given word can be created from these words.            |
